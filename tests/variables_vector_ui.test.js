...
for(const id of ['vx1','vy1','vz1','vx2','vy2','vz2'])if(!html.includes(`id="${id}"`) && html.includes('class="numeric-input expression-input"'))throw new Error(`Campo ${id} não aceita expressão`);
