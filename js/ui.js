(function (global) {
  ...
  const AppUI = {
    ...
    bindProject(){
      ...
      idListen('manualBtn','click',()=>this.openManual());
      idListen('projectManualBtn','click',()=>this.openManual());
    ...
    openManual(){
      const win=global.open('./manual/index.html','orbisv-manual');
      if(!win){this.showToast('O navegador bloqueou a abertura do manual. Permita pop-ups para o OrbisV.',true);return;}
      try{win.focus();}catch{}
    },
    ...
    tourSteps(){return[
      ...
      {title:'Manual didático',text:'O Manual abre em outra aba para permanecer visível enquanto você pratica. Dentro dele, os botões Abrir no OrbisV levam diretamente ao modo ou ferramenta correspondente.',target:()=>document.getElementById('manualBtn'),prepare:()=>this.closeAllModals()},
