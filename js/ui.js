(function (global) {
  ...
  const AppUI = {
    ...
    mathState:null,confirmResolver:null,a11yPrefs:null,viewPrefs:null,tourState:null,tourResizeHandler:null,editingColor:null,
    ...
    washersForm(d){
      ...
      const methodLabel=d.method==='washers'?'Anéis':'Discos',varName=d.axis==='x'?'x':'y';
